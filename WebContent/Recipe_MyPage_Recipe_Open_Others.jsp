...
<%
	...
	// 타인 계정의 레시피 목록에 필요한 변수 선언
	ArrayList<MyPageCompleteRecipeViewDto> otherOpenRecipeList = (ArrayList<MyPageCompleteRecipeViewDto>)request.getAttribute("otherOpenRecipe");
...
<head>
	...
	<link href="Recipe_CSS/Recipe_MyPage_Recipe_Open_Others.css" rel="stylesheet">
...
<!-- 마이페이지 헤더 -->
			<div id="div_mypage_header">
				<div class="div_mypage_header_button">
					<a href="Controller?command=mypage_recipe_view&uId=<%=otherUid%>" class="button-active">
...
<!-- /마이페이지 헤더 -->
<!-- 메인컨텐츠(마이페이지 레시피 공개중 - 다른계정 기준) -->
			<div id="div_mypage_recipe_panel">
				<% if(otherOpenRecipeList.isEmpty()) { %>
				...
				<% 
					for(MyPageCompleteRecipeViewDto otherOpenRecipeObj : otherOpenRecipeList) {
						int recipeId = otherOpenRecipeObj.getRecipeId();
						String recipeThumbnail = otherOpenRecipeObj.getRecipeThumbnail();
						String recipeTitle = otherOpenRecipeObj.getRecipeTitle();
						String recipeWriterNickname = otherOpenRecipeObj.getRecipeWriterNickname();
				%>
									...
									<div id="div_mypage_page_bundle">
										<% if(startPageNum != 1) { %>
											<div class="div_mypage_page_button">
												<a href="Controller?command=mypage_recipe_view&uId=<%=otherUid%>&page=<%=startPageNum-3%>">&lt;&lt;</a>
											</div>
										<% } %>
										<% if(pageNum != 1) { %>
											<div class="div_mypage_page_button">
												<a href="Controller?command=mypage_recipe_view&uId=<%=otherUid%>&page=<%=pageNum-1%>">&lt;</a>
											</div>
										<% } %>
											<% for(int i=startPageNum; i<=endPageNum; i++) { %>
												...
												<% if(pageNum == i) { %>
													<div class="div_mypage_page_button">
														<a href="Controller?command=mypage_recipe_view&uId=<%=otherUid%>&page=<%=i%>" class="button_active"><%=i%></a>
													</div>
												<% } else { %>
													<div class="div_mypage_page_button">
														<a href="Controller?command=mypage_recipe_view&uId=<%=otherUid%>&page=<%=i%>"><%=i%></a>
													</div>
												<% } %>
											<% } %>
										...
										<% if(lastPageNum > endPageNum) { %>
											<div class="div_mypage_page_button">
												<a href="Controller?command=mypage_recipe_view&uId=<%=otherUid%>&page=<%=endPageNum+1%>">&gt;&gt;</a>
											</div>
										<% } %>
									</div>
								<% } else { %>
									<div id="div_mypage_page_bundle">
										<% if(startPageNum != 1) { %>
											<div class="div_mypage_page_button">
												<a href="Controller?command=mypage_recipe_view&searchWord=<%=searchWord%>&uId=<%=otherUid%>&page=<%=startPageNum-3%>">&lt;&lt;</a>
											</div>
										<% } %>
										<% if(pageNum != 1) { %>
											<div class="div_mypage_page_button">
												<a href="Controller?command=mypage_recipe_view&searchWord=<%=searchWord%>&uId=<%=otherUid%>&page=<%=pageNum-1%>">&lt;</a>
											</div>
										<% } %>
											<% for(int i=startPageNum; i<=endPageNum; i++) { %>
												<% if(i > lastPageNum) break; %>
												<% if(pageNum == i) { %>
													<div class="div_mypage_page_button">
														<a href="Controller?command=mypage_recipe_view&searchWord=<%=searchWord%>&uId=<%=otherUid%>&page=<%=i%>" class="button_active"><%=i%></a>
													</div>
												<% } else { %>
													<div class="div_mypage_page_button">
														<a href="Controller?command=mypage_recipe_view&searchWord=<%=searchWord%>&uId=<%=otherUid%>&page=<%=i%>"><%=i%></a>
													</div>
												<% } %>
											<% } %>
										<% if(pageNum < lastPageNum) { %>
										...
										<% if(lastPageNum > endPageNum) { %>
											<div class="div_mypage_page_button">
												<a href="Controller?command=mypage_recipe_view&searchWord=<%=searchWord%>&uId=<%=otherUid%>&page=<%=endPageNum+1%>">&gt;&gt;</a>
											</div>
										<% } %>
									</div>
								<% } %>
