...
<%@page import="dto.MyPageCompleteRecipeViewDto"%>
...
<%
	...
	// 로그인 계정의 레시피 정보에 필요한 변수 선언
	ArrayList<MyPageCompleteRecipeViewDto> myOpenRecipeList = null;
	...
	if(loginId != null) {
		...
		// 로그인 계정의 레시피 정보
		myOpenRecipeList = (ArrayList<MyPageCompleteRecipeViewDto>)request.getAttribute("myOpenRecipe");
	}
...
<head>
	...
	<link href="Recipe_CSS/Recipe_MyPage_Recipe_Open.css" rel="stylesheet">
	...
	<script>
		...
		$(function() {
			let order = "<%=order%>";
			if(order == "null" || order == "latest") {
				$("#div_mypage_recipe_sort2").find("a:nth-child(1)").addClass("sort-active");
			} else if(order == "hit") {
				$("#div_mypage_recipe_sort2").find("a:nth-child(2)").addClass("sort-active");
			} else if(order == "like") {
				$("#div_mypage_recipe_sort2").find("a:nth-child(3)").addClass("sort-active");
			}
			...
			<div id="div_mypage_recipe_panel">
				<div id="div_mypage_recipe_sort">
					<div id="div_mypage_recipe_sort1">
						<div>
							<a class="open_active">공개중</a>
						</div>
						<div>
							<a>작성중</a>
						</div>
					</div>
					<div id="div_mypage_recipe_sort2">
						<a href="Controller?command=mypage_recipe_view&order=latest">최신순</a>
						<a href="Controller?command=mypage_recipe_view&order=hit">조회순</a>
						<a href="Controller?command=mypage_recipe_view&order=like">스크랩순</a>
					</div>
				</div>
				<% if(loginId != null) { %>
					<% if(myOpenRecipeList.isEmpty()) { %>
							<div id="div_mypage_recipe_body">
								<div id="div_mypage_recipe_none">
									...
									<button type="button" onclick="Controller?command=recipe_write_form';"> <!-- 레시피 등록페이지로 이동 -->
										레시피 등록하기
									</button>
								</div>
					...
					<% } else { %>
						<div id="div_mypage_recipe_body">
							...
							<div id="div_mypage_recipe_content">
				<% 
					for(MyPageCompleteRecipeViewDto myOpenRecipeObj : myOpenRecipeList) {
						int recipeId = myOpenRecipeObj.getRecipeId();
						String recipeThumbnail = myOpenRecipeObj.getRecipeThumbnail();
						String recipeTitle = myOpenRecipeObj.getRecipeTitle();
						String recipeWriterNickname = myOpenRecipeObj.getRecipeWriterNickname();
				%>
								<div class="div_mypage_recipe_item">
									<a href="Controller?command=view_recipe_detail&recipeID=<%=recipeId%>"> <!-- 레시피 상세페이지로 이동 -->
										<img src="<%=recipeThumbnail%>"/>
										<div class="div_mypage_recipe_text">
											<span class="span_mypage_recipe_title"><%=recipeTitle%></span>
											<br/>
											by <%=recipeWriterNickname%>
										</div>
									</a>
								</div>
				<% } %>
										...
										<div id="div_mypage_page_bundle">
											<% if(startPageNum != 1) { %>
												<div class="div_mypage_page_button">
													<a href="Controller?command=mypage_recipe_view&page=<%=startPageNum-3%>">&lt;&lt;</a>
												</div>
											<% } %>
											<% if(pageNum != 1) { %>
												<div class="div_mypage_page_button">
													<a href="Controller?command=mypage_recipe_view&page=<%=pageNum-1%>">&lt;</a>
												</div>
											<% } %>
												<% for(int i=startPageNum; i<=endPageNum; i++) { %>
													...
													<% if(pageNum == i) { %>
														<div class="div_mypage_page_button">
															<a href="Controller?command=mypage_recipe_view&page=<%=i%>" class="button_active"><%=i%></a>
														</div>
													<% } else { %>
														<div class="div_mypage_page_button">
															<a href="Controller?command=mypage_recipe_view&page=<%=i%>"><%=i%></a>
														</div>
													<% } %>
												<% } %>
											...
											<% if(lastPageNum > endPageNum) { %>
												<div class="div_mypage_page_button">
													<a href="Controller?command=mypage_recipe_view&page=<%=endPageNum+1%>">&gt;&gt;</a>
												</div>
											<% } %>
										</div>
									<% } else { %>
										<div id="div_mypage_page_bundle">
											<% if(startPageNum != 1) { %>
												<div class="div_mypage_page_button">
													<a href="Controller?command=mypage_recipe_view&searchWord=<%=searchWord%>&page=<%=startPageNum-3%>">&lt;&lt;</a>
												</div>
											<% } %>
											<% if(pageNum != 1) { %>
												<div class="div_mypage_page_button">
													<a href="Controller?command=mypage_recipe_view&searchWord=<%=searchWord%>&page=<%=pageNum-1%>">&lt;</a>
												</div>
											<% } %>
												<% for(int i=startPageNum; i<=endPageNum; i++) { %>
													<% if(i > lastPageNum) break; %>
													<% if(pageNum == i) { %>
														<div class="div_mypage_page_button">
															<a href="Controller?command=mypage_recipe_view&searchWord=<%=searchWord%>&page=<%=i%>" class="button_active"><%=i%></a>
														</div>
													<% } else { %>
														<div class="div_mypage_page_button">
															<a href="Controller?command=mypage_recipe_view&searchWord=<%=searchWord%>&page=<%=i%>"><%=i%></a>
														</div>
													<% } %>
												<% } %>
											<% if(pageNum < lastPageNum) { %>
											...
											<% if(lastPageNum > endPageNum) { %>
												<div class="div_mypage_page_button">
													<a href="Controller?command=mypage_recipe_view&searchWord=<%=searchWord%>&page=<%=endPageNum+1%>">&gt;&gt;</a>
												</div>
											<% } %>
										</div>
									<% } %>
								<% } else if(order.equals("latest")) { %>
									<% if(searchWord == null) { %>
										<div id="div_mypage_page_bundle">
											<% if(startPageNum != 1) { %>
												<div class="div_mypage_page_button">
													<a href="Controller?command=mypage_recipe_view&order=latest&page=<%=startPageNum-3%>">&lt;&lt;</a>
												</div>
											<% } %>
											<% if(pageNum != 1) { %>
												<div class="div_mypage_page_button">
													<a href="Controller?command=mypage_recipe_view&order=latest&page=<%=pageNum-1%>">&lt;</a>
												</div>
											<% } %>
												<% for(int i=startPageNum; i<=endPageNum; i++) { %>
													<% if(i > lastPageNum) break; %>
													<% if(pageNum == i) { %>
														<div class="div_mypage_page_button">
															<a href="Controller?command=mypage_recipe_view&order=latest&page=<%=i%>" class="button_active"><%=i%></a>
														</div>
													<% } else { %>
														<div class="div_mypage_page_button">
															<a href="Controller?command=mypage_recipe_view&order=latest&page=<%=i%>"><%=i%></a>
														</div>
													<% } %>
												<% } %>
											<% if(pageNum < lastPageNum) { %>
											...
											<% if(lastPageNum > endPageNum) { %>
												<div class="div_mypage_page_button">
													<a href="Controller?command=mypage_recipe_view&order=latest&page=<%=endPageNum+1%>">&gt;&gt;</a>
												</div>
											<% } %>
										</div>
									<% } else { %>
										<div id="div_mypage_page_bundle">
											<% if(startPageNum != 1) { %>
												<div class="div_mypage_page_button">
													<a href="Controller?command=mypage_recipe_view&order=latest&searchWord=<%=searchWord%>&page=<%=startPageNum-3%>">&lt;&lt;</a>
												</div>
											<% } %>
											<% if(pageNum != 1) { %>
												<div class="div_mypage_page_button">
													<a href="Controller?command=mypage_recipe_view&order=latest&searchWord=<%=searchWord%>&page=<%=pageNum-1%>">&lt;</a>
												</div>
											<% } %>
												<% for(int i=startPageNum; i<=endPageNum; i++) { %>
													<% if(i > lastPageNum) break; %>
													<% if(pageNum == i) { %>
														<div class="div_mypage_page_button">
															<a href="Controller?command=mypage_recipe_view&order=latest&searchWord=<%=searchWord%>&page=<%=i%>" class="button_active"><%=i%></a>
														</div>
													<% } else { %>
														<div class="div_mypage_page_button">
															<a href="Controller?command=mypage_recipe_view&order=latest&searchWord=<%=searchWord%>&page=<%=i%>"><%=i%></a>
														</div>
													<% } %>
												<% } %>
											<% if(pageNum < lastPageNum) { %>
											...
											<% if(lastPageNum > endPageNum) { %>
												<div class="div_mypage_page_button">
													<a href="Controller?command=mypage_recipe_view&order=latest&searchWord=<%=searchWord%>&page=<%=endPageNum+1%>">&gt;&gt;</a>
												</div>
											<% } %>
										</div>
									<% } %>
								<% } else if(order.equals("hit")) { %>
									<% if(searchWord == null) { %>
										<div id="div_mypage_page_bundle">
											<% if(startPageNum != 1) { %>
												<div class="div_mypage_page_button">
													<a href="Controller?command=mypage_recipe_view&order=hit&page=<%=startPageNum-3%>">&lt;&lt;</a>
												</div>
											<% } %>
											<% if(pageNum != 1) { %>
												<div class="div_mypage_page_button">
													<a href="Controller?command=mypage_recipe_view&order=hit&page=<%=pageNum-1%>">&lt;</a>
												</div>
											<% } %>
												<% for(int i=startPageNum; i<=endPageNum; i++) { %>
													<% if(i > lastPageNum) break; %>
													<% if(pageNum == i) { %>
														<div class="div_mypage_page_button">
															<a href="Controller?command=mypage_recipe_view&order=hit&page=<%=i%>" class="button_active"><%=i%></a>
														</div>
													<% } else { %>
														<div class="div_mypage_page_button">
															<a href="Controller?command=mypage_recipe_view&order=hit&page=<%=i%>"><%=i%></a>
														</div>
													<% } %>
												<% } %>
											<% if(pageNum < lastPageNum) { %>
											...
											<% if(lastPageNum > endPageNum) { %>
												<div class="div_mypage_page_button">
													<a href="Controller?command=mypage_recipe_view&order=hit&page=<%=endPageNum+1%>">&gt;&gt;</a>
												</div>
											<% } %>
										</div>
									<% } else { %>
										<div id="div_mypage_page_bundle">
											<% if(startPageNum != 1) { %>
												<div class="div_mypage_page_button">
													<a href="Controller?command=mypage_recipe_view&order=hit&searchWord=<%=searchWord%>&page=<%=startPageNum-3%>">&lt;&lt;</a>
												</div>
											<% } %>
											<% if(pageNum != 1) { %>
												<div class="div_mypage_page_button">
													<a href="Controller?command=mypage_recipe_view&order=hit&searchWord=<%=searchWord%>&page=<%=pageNum-1%>">&lt;</a>
												</div>
											<% } %>
												<% for(int i=startPageNum; i<=endPageNum; i++) { %>
													<% if(i > lastPageNum) break; %>
													<% if(pageNum == i) { %>
														<div class="div_mypage_page_button">
															<a href="Controller?command=mypage_recipe_view&order=hit&searchWord=<%=searchWord%>&page=<%=i%>" class="button_active"><%=i%></a>
														</div>
													<% } else { %>
														<div class="div_mypage_page_button">
															<a href="Controller?command=mypage_recipe_view&order=hit&searchWord=<%=searchWord%>&page=<%=i%>"><%=i%></a>
														</div>
													<% } %>
												<% } %>
											<% if(pageNum < lastPageNum) { %>
											...
											<% if(lastPageNum > endPageNum) { %>
												<div class="div_mypage_page_button">
													<a href="Controller?command=mypage_recipe_view&order=hit&searchWord=<%=searchWord%>&page=<%=endPageNum+1%>">&gt;&gt;</a>
												</div>
											<% } %>
										</div>
									<% } %>
								<% } else if(order.equals("like")) { %>
									<% if(searchWord == null) { %>
										<div id="div_mypage_page_bundle">
											<% if(startPageNum != 1) { %>
												<div class="div_mypage_page_button">
													<a href="Controller?command=mypage_recipe_view&order=like&page=<%=startPageNum-3%>">&lt;&lt;</a>
												</div>
											<% } %>
											<% if(pageNum != 1) { %>
												<div class="div_mypage_page_button">
													<a href="Controller?command=mypage_recipe_view&order=like&page=<%=pageNum-1%>">&lt;</a>
												</div>
											<% } %>
												<% for(int i=startPageNum; i<=endPageNum; i++) { %>
													<% if(i > lastPageNum) break; %>
													<% if(pageNum == i) { %>
														<div class="div_mypage_page_button">
															<a href="Controller?command=mypage_recipe_view&order=like&page=<%=i%>" class="button_active"><%=i%></a>
														</div>
													<% } else { %>
														<div class="div_mypage_page_button">
															<a href="Controller?command=mypage_recipe_view&order=like&page=<%=i%>"><%=i%></a>
														</div>
													<% } %>
												<% } %>
											<% if(pageNum < lastPageNum) { %>
											...
											<% if(lastPageNum > endPageNum) { %>
												<div class="div_mypage_page_button">
													<a href="Controller?command=mypage_recipe_view&order=like&page=<%=endPageNum+1%>">&gt;&gt;</a>
												</div>
											<% } %>
										</div>
									<% } else { %>
										<div id="div_mypage_page_bundle">
											<% if(startPageNum != 1) { %>
												<div class="div_mypage_page_button">
													<a href="Controller?command=mypage_recipe_view&order=like&searchWord=<%=searchWord%>&page=<%=startPageNum-3%>">&lt;&lt;</a>
												</div>
											<% } %>
											<% if(pageNum != 1) { %>
												<div class="div_mypage_page_button">
													<a href="Controller?command=mypage_recipe_view&order=like&searchWord=<%=searchWord%>&page=<%=pageNum-1%>">&lt;</a>
												</div>
											<% } %>
												<% for(int i=startPageNum; i<=endPageNum; i++) { %>
													<% if(i > lastPageNum) break; %>
													<% if(pageNum == i) { %>
														<div class="div_mypage_page_button">
															<a href="Controller?command=mypage_recipe_view&order=like&searchWord=<%=searchWord%>&page=<%=i%>" class="button_active"><%=i%></a>
														</div>
													<% } else { %>
														<div class="div_mypage_page_button">
															<a href="Controller?command=mypage_recipe_view&order=like&searchWord=<%=searchWord%>&page=<%=i%>"><%=i%></a>
														</div>
													<% } %>
												<% } %>
											<% if(pageNum < lastPageNum) { %>
											...
											<% if(lastPageNum > endPageNum) { %>
												<div class="div_mypage_page_button">
													<a href="Controller?command=mypage_recipe_view&order=like&searchWord=<%=searchWord%>&page=<%=endPageNum+1%>">&gt;&gt;</a>
												</div>
											<% } %>
										</div>
									<% } %>
