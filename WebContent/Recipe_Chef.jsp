...
<head>
	...
	<link href="Recipe_CSS/Recipe_Chef.css" rel="stylesheet"/>
	...
	<script src="js/Recipe_Chef.js"></script>
...
<!-- 쉐프(소식받기순위 + 누적) -->
			<div id="div_chef_panel">
				<div id="div_chef_header">
					<div class="div_chef_presentation">
						<a>쉐프</a>
					</div>
					<div class="div_chef_search">
						<form action="Controller" method="get">
							<input type="hidden" name="command" value="chef_view"/>
							<div class="div_chef_search_bar">
								<span class="glyphicon glyphicon-search"></span>
								<input type="text" name="searchWord" placeholder="쉐프 닉네임을 입력해 주세요."/>
							</div>
							<button onclick=>검색</button>
						</form>
					</div>
				</div>
				<div id="div_chef_advertise">
					<img src="https://recipe1.ezmember.co.kr/img/chef_top3.jpg"/>
				</div>
				<div id="div_chef_sort2">
					<div class="div_chef_sort2_txt">
						<span class="span_chef_sort_title">
							<% if(sort2==null || sort2.equals("all")) { %>
								<span class="sort_date">누적</span>
							<% } else if(sort2.equals("today")) { %>
								<span class="sort_date">오늘</span>
							<% } %>
							<% if(sort1==null || sort1.equals("follower")) { %>
								<span class="sort_how">기준 소식받기</span>
							<% } else if(sort1.equals("hits")) { %>
								<span class="sort_how">기준 조회수</span>
							<% } else if(sort1.equals("likes")) { %>
								<span class="sort_how">기준 레시피 좋아요</span>
							<% } else if(sort1.equals("recipe")) { %>
								<span class="sort_how">기준 레시피</span>
							<% } %>
							많은 쉐프순
						</span>
					</div>
					<div class="div_chef_sort2_how">
						<div>
							<button class="chef_sort2_button">
							...
							<ul id="sort_menu1" class="ul_sort_menu" sort1="<%=sort1%>">
								<li sort="follower">
									<a>소식받기순위</a>
								</li>
								<li sort="hits">
						...
						<div>
							...
							<ul id="sort_menu2" class="ul_sort_menu" sort2="<%=sort2%>">
								<li sort="all">
									<a>누적</a>
								</li>
								<li sort="today">
				...
				<div id="div_chef_body">
					<% for(ChefDto chefObj : chefList) { %>
						<%
							int chefRank = chefObj.getRownum();
						...
						%>
						<div class="div_chef_box">
							<div class="div_chef_box_num"><%=chefRank%></div>
							<div class="div_chef_box_info">
								<div class="div_chef_box_user_img">
									<a href="Controller?command=mypage_recipe_view&uId=<%=chefUid%>">
										<img src="<%=chefProfileImage%>"/>
									</a>
								</div>
								<div class="div_chef_box_user_info">
									<div class="div_chef_box_user_name">
										<a href="Controller?command=mypage_recipe_view&uId=<%=chefUid%>"><%=chefNickname%></a>
										<% if(!(loginId != null && loginId.equals(chefUid))) { %>
											<% if(checkFollow) { %>
												<button type="button" class="btn_follow_user delete" user="<%=chefUid%>">
													<span class="glyphicon glyphicon-minus"></span>
													소식받기 해제
												</button>
											<% } else { %>
												<button type="button" class="btn_follow_user add" user="<%=chefUid%>">
									...
									<div class="div_chef_box_user_figures">
										<span><%=recipeQtyOfChef%></span>
										<span><%=totalRecipeLikesOfChef%></span>
										<span><%=totalRecipeHitsOfChef%></span>
										<span><%=followerQtyOfChef%></span>
									</div>
								</div>
							</div>
						</div>
					<% } %>
					<div class="div_chef_pagebox">
						<div class="div_chef_pagination">
							<% if(searchWord == null) { %>
								<% if(sort1 == null) { %>
									<% if(sort2 == null) { %> 
									<!-- 전부 null(초기값) -->
										<% if(startPageNum > 1) { %>
											<div>
												<a href="Controller?command=chef_view&page=<%=startPageNum-10%>">&lt;&lt;</a>
											</div>
										<% } %>
										<% if(pageNum > 1) { %>
											<div>
												<a href="Controller?command=chef_view&page=<%=pageNum-1%>">&lt;</a>
											</div>
										<% } %>
										<% for(int i=startPageNum; i<=endPageNum; i++) { %>
											...
											<% if(i == pageNum) { %>
												<div>
													<a href="Controller?command=chef_view&page=<%=i%>" class="chef_page_on"><%=i%></a>
												</div>
											<% } else { %>
												<div>
													<a href="Controller?command=chef_view&page=<%=i%>"><%=i%></a>
												</div>
											<% } %>
										<% } %>
										...
										<% if(endPageNum < lastPageNum) { %>
											<div>
												<a href="Controller?command=chef_view&page=<%=endPageNum+1%>">&gt;&gt;</a>
											</div>
										<% } %>
									<% } else { %>
									<!-- sort2만 값 존재 -->
										<% if(startPageNum > 1) { %>
											<div>
												<a href="Controller?command=chef_view&sort2=<%=sort2%>&page=<%=startPageNum-10%>">&lt;&lt;</a>
											</div>
										<% } %>
										<% if(pageNum > 1) { %>
											<div>
												<a href="Controller?command=chef_view&sort2=<%=sort2%>&page=<%=pageNum-1%>">&lt;</a>
											</div>
										<% } %>
										<% for(int i=startPageNum; i<=endPageNum; i++) { %>
											<% if(i > lastPageNum) break; %>
											<% if(i == pageNum) { %>
												<div>
													<a href="Controller?command=chef_view&sort2=<%=sort2%>&page=<%=i%>" class="chef_page_on"><%=i%></a>
												</div>
											<% } else { %>
												<div>
													<a href="Controller?command=chef_view&sort2=<%=sort2%>&page=<%=i%>"><%=i%></a>
												</div>
											<% } %>
										<% } %>
										<% if(pageNum < lastPageNum) { %>
										...
										<% if(endPageNum < lastPageNum) { %>
											<div>
												<a href="Controller?command=chef_view&sort2=<%=sort2%>&page=<%=endPageNum+1%>">&gt;&gt;</a>
											</div>
										<% } %>
									<% } %>
								<% } else { %>
									...
									<!-- sort1만 값 존재 -->
										<% if(startPageNum > 1) { %>
											<div>
												<a href="Controller?command=chef_view&sort1=<%=sort1%>&page=<%=startPageNum-10%>">&lt;&lt;</a>
											</div>
										<% } %>
										<% if(pageNum > 1) { %>
											<div>
												<a href="Controller?command=chef_view&sort1=<%=sort1%>&page=<%=pageNum-1%>">&lt;</a>
											</div>
										<% } %>
										<% for(int i=startPageNum; i<=endPageNum; i++) { %>
											<% if(i > lastPageNum) break; %>
											<% if(i == pageNum) { %>
												<div>
													<a href="Controller?command=chef_view&sort1=<%=sort1%>&page=<%=i%>" class="chef_page_on"><%=i%></a>
												</div>
											<% } else { %>
												<div>
													<a href="Controller?command=chef_view&sort1=<%=sort1%>&page=<%=i%>"><%=i%></a>
												</div>
											<% } %>
										<% } %>
										<% if(pageNum < lastPageNum) { %>
										...
										<% if(endPageNum < lastPageNum) { %>
											<div>
												<a href="Controller?command=chef_view&sort1=<%=sort1%>&page=<%=endPageNum+1%>">&gt;&gt;</a>
											</div>
										<% } %>
									<% } else { %>
									<!-- sort1, sort2 값 존재 -->
										<% if(startPageNum > 1) { %>
											<div>
												<a href="Controller?command=chef_view&sort1=<%=sort1%>&sort2=<%=sort2%>&page=<%=startPageNum-10%>">&lt;&lt;</a>
											</div>
										<% } %>
										<% if(pageNum > 1) { %>
											<div>
												<a href="Controller?command=chef_view&sort1=<%=sort1%>&sort2=<%=sort2%>&page=<%=pageNum-1%>">&lt;</a>
											</div>
										<% } %>
										<% for(int i=startPageNum; i<=endPageNum; i++) { %>
											<% if(i > lastPageNum) break; %>
											<% if(i == pageNum) { %>
												<div>
													<a href="Controller?command=chef_view&sort1=<%=sort1%>&sort2=<%=sort2%>&page=<%=i%>" class="chef_page_on"><%=i%></a>
												</div>
											<% } else { %>
												<div>
													<a href="Controller?command=chef_view&sort1=<%=sort1%>&sort2=<%=sort2%>&page=<%=i%>"><%=i%></a>
												</div>
											<% } %>
										<% } %>
										<% if(pageNum < lastPageNum) { %>
										...
										<% if(endPageNum < lastPageNum) { %>
											<div>
												<a href="Controller?command=chef_view&sort1=<%=sort1%>&sort2=<%=sort2%>&page=<%=endPageNum+1%>">&gt;&gt;</a>
											</div>
										<% } %>
									<% } %>
								<% } %>
								...
								<% if(sort1 == null) { %>
									<% if(sort2 == null) { %>
									 <!-- searchWord만 값 존재 -->
									 	<% if(startPageNum > 1) { %>
											<div>
												<a href="Controller?command=chef_view&searchWord=<%=searchWord%>&page=<%=startPageNum-10%>">&lt;&lt;</a>
											</div>
										<% } %>
										<% if(pageNum > 1) { %>
											<div>
												<a href="Controller?command=chef_view&searchWord=<%=searchWord%>&page=<%=pageNum-1%>">&lt;</a>
											</div>
										<% } %>
										<% for(int i=startPageNum; i<=endPageNum; i++) { %>
											<% if(i > lastPageNum) break; %>
											<% if(i == pageNum) { %>
												<div>
													<a href="Controller?command=chef_view&searchWord=<%=searchWord%>&page=<%=i%>" class="chef_page_on"><%=i%></a>
												</div>
											<% } else { %>
												<div>
													<a href="Controller?command=chef_view&searchWord=<%=searchWord%>&page=<%=i%>"><%=i%></a>
												</div>
											<% } %>
										<% } %>
										<% if(pageNum < lastPageNum) { %>
										...
										<% if(endPageNum < lastPageNum) { %>
											<div>
												<a href="Controller?command=chef_view&searchWord=<%=searchWord%>&page=<%=endPageNum+1%>">&gt;&gt;</a>
											</div>
										<% } %>
									<% } else { %>
									<!-- searchWord, sort2 값 존재 -->
										<% if(startPageNum > 1) { %>
											<div>
												<a href="Controller?command=chef_view&sort2=<%=sort2%>&searchWord=<%=searchWord%>&page=<%=startPageNum-10%>">&lt;&lt;</a>
											</div>
										<% } %>
										<% if(pageNum > 1) { %>
											<div>
												<a href="Controller?command=chef_view&sort2=<%=sort2%>&searchWord=<%=searchWord%>&page=<%=pageNum-1%>">&lt;</a>
											</div>
										<% } %>
										<% for(int i=startPageNum; i<=endPageNum; i++) { %>
											<% if(i > lastPageNum) break; %>
											<% if(i == pageNum) { %>
												<div>
													<a href="Controller?command=chef_view&sort2=<%=sort2%>&searchWord=<%=searchWord%>&page=<%=i%>" class="chef_page_on"><%=i%></a>
												</div>
											<% } else { %>
												<div>
													<a href="Controller?command=chef_view&sort2=<%=sort2%>&searchWord=<%=searchWord%>&page=<%=i%>"><%=i%></a>
												</div>
											<% } %>
										<% } %>
										<% if(pageNum < lastPageNum) { %>
										...
										<% if(endPageNum < lastPageNum) { %>
											<div>
												<a href="Controller?command=chef_view&sort2=<%=sort2%>&searchWord=<%=searchWord%>&page=<%=endPageNum+1%>">&gt;&gt;</a>
											</div>
										<% } %>
									<% } %>
								<% } else { %>
									<% if(sort2 == null) { %>
									 <!-- searchWord, sort1 값 존재 -->
									 	<% if(startPageNum > 1) { %>
											<div>
												<a href="Controller?command=chef_view&sort1=<%=sort1%>&searchWord=<%=searchWord%>&page=<%=startPageNum-10%>">&lt;&lt;</a>
											</div>
										<% } %>
										<% if(pageNum > 1) { %>
											<div>
												<a href="Controller?command=chef_view&sort1=<%=sort1%>&searchWord=<%=searchWord%>&page=<%=pageNum-1%>">&lt;</a>
											</div>
										<% } %>
										<% for(int i=startPageNum; i<=endPageNum; i++) { %>
											<% if(i > lastPageNum) break; %>
											<% if(i == pageNum) { %>
												<div>
													<a href="Controller?command=chef_view&sort1=<%=sort1%>&searchWord=<%=searchWord%>&page=<%=i%>" class="chef_page_on"><%=i%></a>
												</div>
											<% } else { %>
												<div>
													<a href="Controller?command=chef_view&sort1=<%=sort1%>&searchWord=<%=searchWord%>&page=<%=i%>"><%=i%></a>
												</div>
											<% } %>
										<% } %>
										<% if(pageNum < lastPageNum) { %>
										...
										<% if(endPageNum < lastPageNum) { %>
											<div>
												<a href="Controller?command=chef_view&sort1=<%=sort1%>&searchWord=<%=searchWord%>&page=<%=endPageNum+1%>">&gt;&gt;</a>
											</div>
										<% } %>
									<% } else { %>
									<!-- searchWord, sort1, sort2 값 존재 -->
										<% if(startPageNum > 1) { %>
											<div>
												<a href="Controller?command=chef_view&sort1=<%=sort1%>&sort2=<%=sort2%>&searchWord=<%=searchWord%>&page=<%=startPageNum-10%>">&lt;&lt;</a>
											</div>
										<% } %>
										<% if(pageNum > 1) { %>
											<div>
												<a href="Controller?command=chef_view&sort1=<%=sort1%>&sort2=<%=sort2%>&searchWord=<%=searchWord%>&page=<%=pageNum-1%>">&lt;</a>
											</div>
										<% } %>
										<% for(int i=startPageNum; i<=endPageNum; i++) { %>
											<% if(i > lastPageNum) break; %>
											<% if(i == pageNum) { %>
												<div>
													<a href="Controller?command=chef_view&sort1=<%=sort1%>&sort2=<%=sort2%>&searchWord=<%=searchWord%>&page=<%=i%>" class="chef_page_on"><%=i%></a>
												</div>
											<% } else { %>
												<div>
													<a href="Controller?command=chef_view&sort1=<%=sort1%>&sort2=<%=sort2%>&searchWord=<%=searchWord%>&page=<%=i%>"><%=i%></a>
												</div>
											<% } %>
										<% } %>
										<% if(pageNum < lastPageNum) { %>
										...
										<% if(endPageNum < lastPageNum) { %>
											<div>
												<a href="Controller?command=chef_view&sort1=<%=sort1%>&sort2=<%=sort2%>&searchWord=<%=searchWord%>&page=<%=endPageNum+1%>">&gt;&gt;</a>
											</div>
										<% } %>
									<% } %>
								<% } %>
