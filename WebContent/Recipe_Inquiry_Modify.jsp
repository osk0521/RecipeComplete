...
<!-- 문의사항 작성 -->
			<form action="Controller" method="post">
				...
				<!-- 일단 값 넣긴했고 검증해야됨 -->
				<input type="text" name="inquiry_title" id="inquiry_write_title" value="${inquiryTitle}" placeholder="제목">
				<div class="blank_space"></div>
<!-- 여기에 삽입 -->
<!-- <button type="button" id="btn_yg">YGYG</button> -->
				<div id="div_inquiry_content">
					<textarea name="inquiry_content" id="inquiry_write_content" placeholder="내용">${inquiryContent}</textarea>
				</div>
<!-- /여기에 삽입 -->
				<div class="blank_space"></div>
				<div id="div_inquiry_regbar">
					<button type="button" id="button_reg_inquiry">수정</button>
