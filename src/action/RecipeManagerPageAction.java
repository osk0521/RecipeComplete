...
public class RecipeManagerPageAction implements Action {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<RecipeManagerUserVo> getUserlist = RecipeManagerDao.getUserList();
		ArrayList<RecipeManagerCategoryVo> getlistForWhat = RecipeManagerDao.getManagerCategory("what");
		ArrayList<RecipeManagerCategoryVo> getlistForSituation = RecipeManagerDao.getManagerCategory("situation");
		ArrayList<RecipeManagerCategoryVo> getlistForKind = RecipeManagerDao.getManagerCategory("kind");
		request.setAttribute("getUserlist", getUserlist);
		request.setAttribute("getlistForWhat", getlistForWhat);
		request.setAttribute("getlistForSituation", getlistForSituation);
		request.setAttribute("getlistForKind", getlistForKind);
		RequestDispatcher rd = request.getRequestDispatcher("Recipe_Manager.jsp");
